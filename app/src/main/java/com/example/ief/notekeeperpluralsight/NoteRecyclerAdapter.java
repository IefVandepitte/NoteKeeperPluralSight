...
import static com.example.ief.notekeeperpluralsight.NoteKeeperDatabaseContract.*;

/**
 * Created by ief on 6/11/2017.
 */
...
public NoteRecyclerAdapter(Context mContext, Cursor mCursor) {
...
//                    intent.putExtra(NoteActivity.NOTE_ID, mCurrentPosition);
