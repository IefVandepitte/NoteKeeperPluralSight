...
import com.example.ief.notekeeperpluralsight.NoteKeeperProviderContract.CoursesIdColumns;
...
public class NoteKeeperProvider extends ContentProvider {
    ...
    public String getType(Uri uri) {
        ...
        switch(uriMatch){
            case COURSES:
                // vnd.android.cursor.dir/vnd.com.example.ief.notekeeperpluralsight.provider.courses
       ...
       switch (uriMatch) {
           case NOTES:
              rowId = db.insert(NoteInfoEntry.TABLE_NAME, null, values);
               // content://com.example.ief.notekeeper.provider/notes/1
...
//                null,null,sortOrder);
        //met tafelqualificatie voor de _id
